...
# Set WD
setwd("VGBM Data Prep/CVS Data Files")
...
# Virginia
setwd("C:/Users/Grant Adams/Dropbox/2017_Sheepshead_Growth_Variation/Data/Virginia/CSV_files")
virginia.data <- c()
...
# SC
sc.data <- read.csv("C:/Users/Grant Adams/Dropbox/2017_Sheepshead_Growth_Variation/Data/South Carolina/SCDNR_Sheepshead.csv")
...
setwd("C:/Users/Grant Adams/Dropbox/2017_Sheepshead_Growth_Variation/Sheepshead R Work/Data Prep/CVS Data Files")
...
fl.tl.regression.hlm <- lme(FL_mm ~ TL_mm, random = ~TL_mm|state, data = fl.tl)
...
# Add spatial data
setwd("C:/Users/Grant Adams/Google Drive/2017_Sheepshead_Growth_Variation/Sheepshead R Work")
library(rgdal)
library(sp)
management_centroids <- rgdal::readOGR("State Boundaries", "coastal_management_centroids_w_ga")
...
setwd("C:/Users/Grant Adams/Google Drive/2017_Sheepshead_Growth_Variation/Sheepshead R Work/von Bertalanffy")
save(dat, file = "Sheepshead_data_GOM.RData" )

write.csv(dat, file = "Sheepshead_VA_to_TX_biological_data.csv")